...
#                        status_callback_event='answered', # Optional or initiated, ringing, answered & completed default = completed, ignored if application_sid is present
#                        status_callback_method='GET', #Optional, default = POST

# *** Create a Call & specify a 'queued' Status Callback Event ***
...
#                        send_digits='#', # Optional, valid characters = 0-9, #, * & w (pause)
                         ...
                         status_callback_event='queued', # Optional, or answered, completed, initiated or ringing, default = completed, ignored if application_sid is present

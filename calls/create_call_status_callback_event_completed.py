# *** Create a Call & specify a 'completed' Status Callback Event ***
...
#                        send_digits='#', # Optional, valid characters = 0-9, #, * & w (pause)
                         ...
                         status_callback_event='completed', # Optional, or answered, initiated, queued or ringing, default = completed, ignored if application_sid is present

# *** Create a Call & specify a 'answered' Status Callback Event ***
...
#                        send_digits='#', # Optional, valid characters = 0-9, #, * & w (pause)
                         ...
                         status_callback_event='answered', # Optional, or completed, initiated, queued or ringing, default = completed, ignored if application_sid is present

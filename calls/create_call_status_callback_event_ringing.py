# *** Create a Call & specify a 'ringing' Status Callback Event ***
...
#                        send_digits='#', # Optional, valid characters = 0-9, #, * & w (pause)
                         ...
                         status_callback_event='ringing', # Optional, or answered, completed, initiated or queued, default = completed, ignored if application_sid is present

...
summary = client.calls \
                .feedback_summaries \
                .create(
                        end_date="2018-10-05", # Required
                        include_subaccounts=True, # Required, default false
                        start_date="2014-01-01", # Required
                        status_callback="http://www.example.com/feedback", #Optional

# *** Create a Call & specify a 'initiated' Status Callback Event ***
...
#                        send_digits='#', # Optional, valid characters = 0-9, #, * & w (pause)
                         ...
                         status_callback_event='initiated', # Optional, or answered, completed, queued or ringing, default = completed, ignored if application_sid is present

# *** List Conferences by friendly_name ***
...
#                                    date_created=date(2014, 5, 21), #Optional, datetime('YYYY-MM-DD')
#                                    date_updated=date(YYYY, MM, DD), #Optional, date(YYYY, MM, DD)
                                     friendly_name='tornado', #Optional
#                                    status='completed' #Optional, init, in-progress or completed
                                     )

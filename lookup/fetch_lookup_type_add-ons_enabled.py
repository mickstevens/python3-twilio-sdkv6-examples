...
phone_number = client.lookups \
                            ...
                            .fetch(
                            add_ons='payfone_tcpa_compliance', # Optional, Add-On Unique Names
                            add_ons_data={'payfone_tcpa_compliance.right_party_contacted_date': '20160101'}, # Optional, Add-On Unique Names 
                            country_code='US', # Optional, ISO Country Code
                            type='carrier' # Optional, or caller-name, default = null, fraud = bet
                            )

# *** Create a Deployement Role with Edit only permissions for Chat ***
...
role = client.chat.services('ISd2be945e1a6d417db86874d169e2d394') \
                  .roles \
                  .create(
                       friendly_name='Deployment - Edit only Permissions',
                       type='deployment',
                       permission=['editAnyMessage', 'editAnyMessageAttributes', 'editAnyUserInfo', 'editChannelAttributes', 'editChannelName', 'editOwnMessage', 'editOwnMessageAttributes', 'editOwnUserInfo']
                   )

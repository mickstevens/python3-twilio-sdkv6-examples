# *** Create an FCM Credential for Chat ***
...
#                                        sandbox='false', # Optional, apn only, use this credential for sending to production or sandbox apn
                                         secret='xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx' # Optional, fcm only, This is the "Server key" of your project from Firebase console under Settings / Cloud messaging
                                     )

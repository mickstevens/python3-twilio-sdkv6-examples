# *** Create a Channel Type Role with User only permissions for Chat ***
...
role = client.chat.services('ISxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx') \
                  .roles \
                  .create(
                       friendly_name='Channel - User only Permissions',
                       type='channel',
                       permission=['editAnyUserInfo', 'editOwnUserInfo']
                       # both not supported for channel role type ?
                         )

# *** Create a Channel Type Role with Channel only permissions for Chat ***
...
role = client.chat.services('ISxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx') \
                  .roles \
                  .create(
                       friendly_name='Channel - Channel only Permissions',
                       type='channel',
                       permission=['destroyChannel', 'editChannelName', 'editChannelAttributes', 'leaveChannel']
                   )

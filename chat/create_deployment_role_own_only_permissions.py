# *** Create a Deployement Role with Own only permissions for Chat ***
...
role = client.chat.services('ISd2be945e1a6d417db86874d169e2d394') \
                  .roles \
                  .create(
                       friendly_name='Deployment - Own only Permissions',
                       type='deployment',
                       permission=['editOwnMessage', 'editOwnMessageAttributes', 'editOwnUserInfo']
                   )

# *** Create a Deployement Role with Message only permissions for Chat ***
...
role = client.chat.services('ISd2be945e1a6d417db86874d169e2d394') \
                  .roles \
                  .create(
                       friendly_name='Deployment - Message only Permissions',
                       type='deployment',
                       permission=['deleteAnyMessage', 'editAnyMessage', 'editAnyMessageAttributes', 'editOwnMessage', 'editOwnMessageAttributes']
                   )

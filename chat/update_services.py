...
service = client.chat.services('ISxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx') \
                     .update(
                         ...
                         limits_channel_members="23", #Optional, max 1000
                         limits_user_channels="23", #Optional, max 1000
                         post_webhook_retry_count="1",
                         post_webhook_url="http://bit.ly",
                         pre_webhook_retry_count="1",
                         pre_webhook_url="http://ow.ly",
                         reachability_enabled="true", # Optional, or false (default)
                         read_status_enabled="false", # Optional, or true (default)
                         typing_indicator_timeout="5", # Optional
                         webhook_filters="",
                         webhook_method="POST"
                            )

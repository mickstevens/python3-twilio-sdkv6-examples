# *** Create a Channel Type Role with Own only permissions for Chat ***
...
role = client.chat.services('ISxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx') \
                  .roles \
                  .create(
                       friendly_name='Channel - Own only Permissions',
                       type='channel',
                       permission=['deleteOwnMessage', 'editOwnMessage', 'editOwnMessageAttributes'] 
                       #'editOwnUserInfo' not supported ?
                         )

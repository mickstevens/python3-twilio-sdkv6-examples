# *** Create a Channel Type Role with Edit only permissions for Chat ***
...
role = client.chat.services('ISxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx') \
                  .roles \
                  .create(
                       friendly_name='Channel - Edit only Permissions',
                       type='channel',
                       permission=['editAnyMessage', 'editAnyMessageAttributes', 'editOwnMessage', 'editOwnMessageAttributes', 'editChannelName', 'editChannelAttributes'] 

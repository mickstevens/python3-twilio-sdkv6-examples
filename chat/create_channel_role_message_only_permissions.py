# *** Create a Channel Type Role with Message only permissions for Chat ***
...
role = client.chat.services('ISxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx') \
                  .roles \
                  .create(
                       friendly_name='Channel - Message only Permissions',
                       type='channel',
                       permission=['deleteAnyMessage', 'deleteOwnMessage', 'editAnyMessage', 'editAnyMessageAttributes', 'editOwnMessage', 'editOwnMessageAttributes', 'sendMessage', 'sendMediaMessage']
                         )
